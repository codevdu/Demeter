...
const navItems: NavItem[] = [
  { href: "/tecnico", label: "Visão Geral", icon: LayoutDashboard },
  { href: "/tecnico/regiao", label: "Ver região", icon: Map },
];
        ...
        >
          {isOpen ? (
            <div>
              ...
              <p className="text-xs text-muted-foreground">Área do técnico</p>
            </div>
          ) : (
            <p></p>
          )}
